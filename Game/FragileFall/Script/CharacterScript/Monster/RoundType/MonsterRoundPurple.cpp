...
namespace game
{
    ...
    void MonsterRoundPurple::Start()
    {
        ...
        {
            meshRenderer->SetBaseColor(engine::Vector4(0.5f, 0.0f, 0.5f, 1.0f));
        }
    }
    ...
    {
        // Purple: 기본 Linear 총알 (추후 특수 패턴으로 변경 가능)
    ...
    void MonsterRoundPurple::OnGui()
    {
        ...
        ImGui::TextColored(ImVec4(0.5f, 0.0f, 0.5f, 1.0f), "Tier: Purple");
