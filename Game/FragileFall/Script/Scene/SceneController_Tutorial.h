...
namespace game
{
    ...
    class SceneController_Tutorial :
        public engine::Script<SceneController_Tutorial>
    {
        REGISTER_SCRIPT(SceneController_Tutorial, Script)
    ...
    private:
        ...
        void CheckBackToTutorialLobby(bool open);
