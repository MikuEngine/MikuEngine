...
{
    // ═══════════════════════════════════════════════════════════════
    // BossBulletThreeway - 보스 3방향 총알 컴포넌트
    // 
    // Strategy 패턴:
    //   - IBulletMovement로 이동 방식을 주입받음 (Linear만 사용)
    //   - BulletFactory::ThreewayFireBoss()에서 생성 시 Movement 설정
    // 
    // 책임:
    ...
    class BossBulletThreeway :
        public engine::Script<BossBulletThreeway>
    {
        REGISTER_SCRIPT(BossBulletThreeway, Script)
